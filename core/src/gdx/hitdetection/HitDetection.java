...
public class HitDetection extends ApplicationAdapter implements InputProcessor {
    ...
    public void create() {
        ...
        sprVlad = new Sprite2(txHero, fSx, fSy, fW, fH, 300, 500, 0.1, 0, 5);
    ...
    public static boolean canJump(Sprite2 spr, Sprite sprWall) {
    ...
    public static boolean isHit(Sprite2 spr1, Sprite spr2) {
        ...
        if (spr1.retRect().overlaps(spr2.getBoundingRectangle())) {
            //System.out.println("is hit");
            return true;
        } else {
            return false;
